...
export default {
  ...
  methods: {
    ...
    onResize(e) {
      ...
      if (this.width > 1200) {this.news = this.myNews.slice(0, 5);}
      if (this.width <= 1200 && this.width >= 1000) {this.news = this.myNews.slice(0, 4);}
      if (this.width <= 1000 && this.width >= 700) {this.news = this.myNews.slice(0, 3);}
      if (this.width < 700) {this.news = this.myNews.slice(0, 2);}
    },
  },
};
</script>
